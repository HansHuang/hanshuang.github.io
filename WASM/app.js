...
Module['FS_createPath']("/misc", "fonts", true, true);
          ...
          DataRequest.prototype.byteArray = byteArray;
            ...
            for (var i = 0; i < files.length; ++i) {
              DataRequest.prototype.requests[files[i].filename].onload();
                ...
                Module['removeRunDependency']('datafile_../web/app.data');

      };
      Module['addRunDependency']('datafile_../web/app.data');
...
function resizeCanvas(){ Module.resizeCanvas(); }
